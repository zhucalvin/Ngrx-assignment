import {
  ...
  import * as fromProducts from 'src/app/core/reducers/products.reducer';
   ...
   * Layout Selectors
   */
  export const retrievedProductsState = createFeatureSelector<fromProducts.State>(
    fromProducts.productsFeatureKey
  );
  
  export const retrievedProducts = createSelector(
    retrievedProductsState,
